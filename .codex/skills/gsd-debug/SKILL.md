...
```bash
debugger_model=$(node "C:/Users/Samuel Vitor/Documents/aplicativos/direcao_financeira/.codex/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-debugger --raw)
```
