...
class ExpensesChartSection extends GetView<HomeController> {
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (isCompact) ...[
                  Center(child: _buildChart(gastos, chartSize)),
                  const SizedBox(height: 20),
                  _buildLegend(gastos),
                ] else ...[
                  Row(
                    children: [
                      _buildChart(gastos, chartSize),
                      const SizedBox(width: 24),
                      Expanded(child: _buildLegend(gastos)),
                    ],
                  ),
                ],
                const SizedBox(height: 20),
  ...
  Widget _buildChart(List<Map<String, dynamic>> gastos, double size) {
    return SizedBox(
      width: size,
      height: size,
      child: CustomPaint(
  ...
  Widget _buildLegend(List<Map<String, dynamic>> gastos) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
